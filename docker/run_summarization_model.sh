...
THIRDPID=${!};
CUDA_VISIBLE_DEVICES=3 /home/joppew/titan/docker/docker_run_gpu.sh --name="${USER}3" --rm -t -v /home/joppew/logs_dropout_500_2:/logs joppew/asudl:latest bash /model/start_script.sh --data_dir=/data/ --logs_dir=/logs/ --train_dir=/logs/ --vocab_size=30000 --dropout_keep_prob=0.5 --size=1 --num_layers=1 --batch_size=64 --steps_per_checkpoint=500 --steps_per_scheduled_job=500 &
FOURTHPID=${!};
